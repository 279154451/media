...
public class FUDrawable2d {
     ...
     */
    public FUDrawable2d(float[] FULL_RECTANGLE_COORDS, float[] FULL_RECTANGLE_TEX_COORDS) {
     ...
     * Does no EGL/GL operations, so this can be done at any time.
     */
    public FUDrawable2d(float[] FULL_RECTANGLE_COORDS) {
        updateVertexArray(FULL_RECTANGLE_COORDS);
    }

    public void updateVertexArray(float[] FULL_RECTANGLE_COORDS) {
        mVertexArray = FUGLUtils.createFloatBuffer(FULL_RECTANGLE_COORDS);
    ...
    public void updateTexCoordArray(float[] FULL_RECTANGLE_TEX_COORDS) {
        mTexCoordArray = FUGLUtils.createFloatBuffer(FULL_RECTANGLE_TEX_COORDS);
    }
